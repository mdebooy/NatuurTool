...
\newfontfamily\farsifontsf[Script=Arabic,Scale=1.1,WordSpace=2]{KacstFarsi}

\setdefaultlanguage{dutch}
\setotherlanguages{afrikaans,arabic,belarusian,bulgarian,catalan,croatian,%
czech,danish,english,estonian,finnish,french,german,greek,hebrew,hungarian,%
icelandic,italian,japanese,latvian,lithuanian,macedonian,malay,malayalam,%
norwegian,persian,polish,portuguese,romanian,russian,sami,slovak,slovenian,%
spanish,swedish,serbian,thai,turkish,ukrainian,vietnamese}
...
%    \case{ko}{| #2\,\textsuperscript{(#1)}}%
    ...
    \case{se}{| \foreignlanguage{sami}{#2}\,\textsuperscript{(#1)}}%
...
\textsuperscript{(be)} \worldflag{by} Wit-Russisch (Беларуская),
\textsuperscript{(bg)} \worldflag{bg} Bulgaars (български език),
...
\textsuperscript{(el)} \worldflag{gr} Grieks (Ελληνικά),
...
%\textsuperscript{(ko)} \worldflag{kr} Koreaans (한국어),
...
\textsuperscript{(ro)} \worldflag{ro} Roemeens (Română),
...
\textsuperscript{(sr)} \worldflag{ro} Roemeens (Română),
