...
\textsuperscript{(bel)} \worldflag{by} Wit-Russisch (\foreignlanguage{belarusian}{Беларуская}),
...
\textsuperscript{(ces)} \worldflag{cz} Tsjechisch (\foreignlanguage{czech}{česky}),
...
\textsuperscript{(lit)} \worldflag{lt} Litouws (\foreignlanguage{lithuanian}{lietuvių}),
...
\textsuperscript{(pol)} \worldflag{pl} Pools (\foreignlanguage{polish}{język polski}),
...
\textsuperscript{(slk)} \worldflag{sk} Slowaaks (\foreignlanguage{slovak}{slovenčina}),
